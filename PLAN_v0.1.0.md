...
**Goal**: Bun project + TailwindCSS v4 pipeline + working HTTP server + base HTML with navigation.

**Files to create:**
- `package.json` — scripts: `dev`, `dev:server`, `dev:css`, `build:css`, `test`, `test:e2e`
- `.gitignore` — node_modules, .env, data/, backups/, output.css
...
7. `bun run dev` starts server and CSS watcher correctly
